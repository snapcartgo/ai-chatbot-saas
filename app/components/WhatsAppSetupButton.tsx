...
export const WhatsAppSetupButton: React.FC<WhatsAppSetupButtonProps> = ({ clientId }) => {
  ...
  // 💡 Keep track of the code generated by the login callback
    ...
    const handleEmbeddedMessage = async (event: MessageEvent) => {
      ...
      try {
        ...
        if (data.type === "WA_EMBEDDED_SIGNUP" && data.event === "FINISH") {
          ...
          // 💡 Wait briefly if FB.login hasn't updated the ref yet
          let attempts = 0;
          ...
          const payload = {
            ...
            access_token: pendingAuthCodeRef.current, // 💡 PASSING REAL CODE HERE NOW
          };

          console.log("Sending final onboarding payload to backend:", payload);
  ...
  const launchWhatsAppSignup = () => {
    ...
    pendingAuthCodeRef.current = null; // reset cache
    ...
    window.FB.login(
      (response: any) => {
        ...
        // 💡 Capture the true verification 'code' from Meta
        const authCode = response.authResponse.code;
        console.log("Captured Authorization Code:", authCode);
        
        // 💡 Cache it so the message listener block can include it
        pendingAuthCodeRef.current = authCode || null;
