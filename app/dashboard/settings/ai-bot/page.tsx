...
// Initialize client once outside component render cycle
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-xl font-bold text-gray-900">OpenAI Chat Bot Setup</h1>
        ...
        <form onSubmit={handleSubmit} className="bg-white border border-gray-200 rounded-2xl p-6 shadow-sm space-y-6">
          ...
          <p className="text-sm text-gray-600 leading-relaxed border-b border-gray-100 pb-4">
            Using OpenAI you can build your chatbot for your custom information so it can answer customer questions on WhatsApp and Web widgets automatically.
          </p>

          {/* Toggle 1: Enable Chat Bot */}
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-200">
            <div>
              <p className="text-sm font-semibold text-gray-900">Enable OpenAI Chat Bot</p>
              <p className="text-xs text-gray-500">Master switch to turn AI responses on or off.</p>
            </div>
          ...
          <div className="bg-amber-50 border border-amber-200 rounded-xl p-4 flex items-start gap-3 text-amber-800">
            ...
            <p className="text-xs leading-5">
              <strong>Note:</strong> Enabling this will send user message history to OpenAI to provide context. API usage charges will apply directly to your OpenAI account.
            </p>
          </div>
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-200">
            <div>
              <p className="text-sm font-semibold text-gray-900">Use existing chat history as context</p>
              <p className="text-xs text-gray-500">Allows AI to remember previous messages during conversation.</p>
            </div>
            <label className="relative inline-flex items-center cursor-pointer">
              <input
                type="checkbox"
                checked={formData.useHistoryContext}
                onChange={(e) => setFormData({ ...formData, useHistoryContext: e.target.checked })}
                className="sr-only peer"
              />
              <div className="w-11 h-6 bg-gray-300 peer-focus:outline-none rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all peer-checked:bg-emerald-600"></div>
            </label>
            ...
            <div>
              ...
              <div className="relative flex items-center">
                <input
                  ...
                  className="w-full bg-gray-50 border border-gray-300 rounded-xl pl-4 pr-12 py-3 text-sm text-gray-900 focus:bg-white focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 outline-none transition-all"
                />
          ...
          <div className="pt-4 border-t border-gray-100 flex justify-end">
            <button
              type="submit"
              disabled={loading}
              className="bg-emerald-600 hover:bg-emerald-700 text-white font-semibold text-sm px-8 py-3 rounded-xl shadow-md hover:shadow-lg transition-all disabled:opacity-50 flex items-center gap-2"
            >
              {loading && (
